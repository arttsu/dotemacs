...
2. Install:
   ...
   #+begin_src shell
     cd ~/Downloads
     tar xaf anki-24.04.1-linux-qt6.tar.zst # might need to install zstd
     cd anki-24.04.1-linux-qt6/
     sudo ./install.sh
   #+end_src

3. Add [[https://git.foosoft.net/alex/anki-connect][anki-connect]] addon
