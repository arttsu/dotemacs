...
#+begin_src elisp
  ...
  (defconst my/gtd-agenda-files (list my/calendar-file
                                      ...
                                      my/projects-file))
#+end_src
**** Org Mode: Execute source block via Avy
#+begin_src elisp
...
#+end_src
**** Org Mode: GTD: Capture templates
#+begin_src elisp
