...
- [[#packages][Packages]]
  - [[#helpers][Helpers]]
    - [[#pop-mark][Pop mark]]
    - [[#insert-date-or-datetime][Insert date or datetime]]
  - [[#emacs][Emacs]]
    - [[#my-emacs][My Emacs]]
  - [[#envrc][envrc]]
  ...
  - [[#ledger][Ledger]]
    - [[#my-ledger][My Ledger]]
  - [[#vterm][Vterm]]
    - [[#vterm-unbind-function-keys][Vterm: Unbind function keys]]
    - [[#vterm-configure][Vterm: Configure]]
  - [[#shell][Shell]]
  - [[#copilot][Copilot]]
  ...
  - [[#easysession][easysession]]
    - [[#dont-autosave-main-session][Don't autosave 'main' session]]
    - [[#save-only-visible-buffers][Save only visible buffers]]
    - [[#new-session-setup][New session setup]]
    - [[#easysession-configure][easysession: Configure]]
...
#+end_src
**** Checklists: After checking an item automatically move to the next one
#+begin_src elisp
