...
#+end_src
****** Org: Update attachments heading
#+begin_src elisp
...
#+end_src
****** Org: Auto-update attachments on save
#+begin_src elisp
...
#+end_src
**** Babel Restclient :RTFM:
https://github.com/alf/ob-restclient.el
***** Babel Restclient: Use-package
#+begin_src elisp
...
***** GitHub-flavored Markdown export: Use-package
#+begin_src elisp
  (use-package ox-gfm
    :ensure
    :after org)
...
***** Ledger: Balance for period helper
#+begin_src elisp
...
#+end_src
**** LSP mode :RTFM:
***** LSP mode: Corfu completion
#+begin_src elisp
  (defun lsp-corfu-setup ()
    (setq-local completion-styles '(orderless)
                completion-category-defaults nil))
#+end_src
***** LSP mode: Use-package
#+begin_src elisp
...
#+end_src
**** Scala Tree Sitter :RTFM:
https://github.com/KaranAhlawat/scala-ts-mode
***** Scala Tree Sitter: Use-package
#+begin_src elisp
